    ...
    try {
        (() => {
            ...
            WebGLRenderingContext.prototype.getParameter = function(param) {
                ...
                if (param === 0x1F01) return 'ANGLE (Generic)';
                if (param === 0x1F02) return 'WebGL 1.0 (OpenGL ES 2.0 Chromium)';
                if (param === 0x0D33) return 4096 + Math.floor(Math.random() * 4096);
                if (param === 0x0D2A) return new Int32Array([4096, 4096]);
